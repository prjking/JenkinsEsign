...
//		File movieFolder = new File(System.getProperty("user.dir") + "/src/test/Videos/");
...
//
//		File file = new File(System.getProperty("user.dir") + "/src/test/Videos/");
	...
	public static void startRecord(String methodName) throws Exception {
		...
		screenRecorder = new ScreenRecorderUtil(gc, captureSize,
				...
				new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_QUICKTIME_JPEG, CompressorNameKey,
						COMPRESSOR_NAME_QUICKTIME_JPEG, DepthKey, 24, FrameRateKey, Rational.valueOf(15), QualityKey,
						0.5f, KeyFrameIntervalKey, 15 * 60),
				new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, "black", FrameRateKey, Rational.valueOf(30)),
				null, file, methodName);
		screenRecorder.start();
	}
