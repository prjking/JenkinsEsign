...
public class EntitiesMeghana {
	...
	public void ExportAll() throws Exception {
		...
		waitEle(By.xpath("//button[@class='el-tooltip p-button-sm p-button-secondary p-button-outlined export-button p-button p-component']"));
	...
	public void addtemplates() throws Exception {
		...
		WebElement FullName = wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//div[@class='el-scrollbar__view'])[2]//ul//li[2]")));
	...
	public void Action() throws Exception {
		...
		try {
			driver.findElement(
					...
					.sendKeys("Testing purpose1 please ignore this mail and continue the process,People who produce designs are called designers");
	...
	public void Businessentityindex() throws Exception {
		...
		waitEle(By.xpath("(//span[normalize-space()='Create new'])[2]"));
	...
	public void AssignData() throws Exception {
		...
		WebElement element = wait1.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//span[normalize-space()='Save']")));
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", element);
		...
		waitEle(By.xpath("(//button[@class='el-button el-tooltip right-block float-right add-buttons mt-0 button-uppercase el-button--default'])[1]"));
		...
		WebElement element1 = wait1.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//button[@class='el-button el-button--primary']")));
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", element1);
		System.out.println("clicked on save Sucessfully");
		
		Thread.sleep(10000);
		WebElement EntityField = driver.findElement(By.xpath("(//span//p[normalize-space()='ramya; teju; meghana'])[1]"));
...
//		form rule-2
	...
	public void AddCurrField() throws Exception {
		...
		WebElement Currency = driver.findElement(By.xpath("(//button[@class='el-button field-element el-button--default'])[35]"));
	...
	public void AddDatato1553() throws Exception {
		...
		waitEle(By.xpath("(//button[@class='el-button el-tooltip right-block float-right add-buttons mt-0 button-uppercase el-button--default'])[2]"));
		...
		WebElement EntityField = driver.findElement(By.xpath("(//td[@class='el-table_2_column_4   el-table__cell']//div//span)[1]"));
	...
	public void AddDatato1299() throws Exception {
		...
		WebElement EntityField = driver.findElement(By.xpath("(//td[@class='el-table_17_column_84   el-table__cell'])[1]"));
