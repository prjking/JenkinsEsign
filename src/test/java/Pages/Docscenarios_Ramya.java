...
public class Docscenarios_Ramya {
	
	WebDriver driver;

	public Docscenarios_Ramya(WebDriver driver) {
	...
	public void DocScenario() throws Exception {
		...
		Thread.sleep(10000);
		waitEle(By
				.xpath("//button[@class='el-button scaling-button el-button--primary create-btn px-4 ml-2']"));
